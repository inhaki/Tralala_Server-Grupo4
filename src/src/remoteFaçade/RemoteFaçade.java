...
import data.Cancion;
import data.Usuario;
import externalServices.LoginService;
import gateway.GatewayAutentificacion;
...
public class RemoteFaçade extends UnicastRemoteObject implements IRemoteFaçade{
	...
	public boolean state; //antes estaba Usuario state
	...
	public boolean login(String email, String password) {		
		...
		this.state = GatewayAutentificacion.getInstance().login(email, password);
